...
void runtime_observation_capture(const ecu_state_t *s, runtime_observation_t *o)
{
    *o = (runtime_observation_t){
        ...
        .memory_check_ms = s->control.memory_diagnostic.checked_ms,
        .memory_check_valid = s->control.memory_diagnostic.valid,
        .memory_check_failed = s->control.memory_diagnostic.failed,
