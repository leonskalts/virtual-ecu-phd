...
SWEEP_PROFILES: Dict[str, Sequence[SweepDefinition]] = {
    "quick": (
        ...
        SweepDefinition(
            campaign_id="timing_stale_sensor_data_sweep",
            campaign_type="custom_single_fault",
            fault_class="timing/communication-path fault",
            fault_type="stale_sensor_data",
            fault_behavior="transient",
            start_times_ms=(50000, 65000),
            durations_ms=(30000, 50000),
            parameters=(8000.0, 12000.0),
        ),
        SweepDefinition(
            campaign_id="timing_stale_sensor_data_persistent_sweep",
            campaign_type="custom_single_fault",
            fault_class="timing/communication-path fault",
            fault_type="stale_sensor_data",
            fault_behavior="permanent",
            start_times_ms=(65000, 75000),
            durations_ms=(0,),
            parameters=(15000.0, 20000.0),
        ),
        SweepDefinition(
    ...
    "conference": (
        ...
        SweepDefinition(
            ...
            fault_type="stale_sensor_data",
            fault_behavior="transient",
            start_times_ms=(45000, 60000, 75000),
            durations_ms=(20000, 40000, 50000),
            parameters=(8000.0, 12000.0, 15000.0),
        ),
        SweepDefinition(
            campaign_id="timing_stale_sensor_data_persistent_sweep",
            campaign_type="custom_single_fault",
            ...
            fault_type="stale_sensor_data",
            fault_behavior="permanent",
            start_times_ms=(60000, 70000, 80000),
            durations_ms=(0,),
            parameters=(12000.0, 15000.0, 20000.0),
        ),
        SweepDefinition(
            campaign_id="actuation_pump_degraded_sweep",
            campaign_type="custom_single_fault",
