...
| thermal_observer | 6/6 | 100.0% | 7.033 | 0 | 0 |
...
- Thermal observer mismatch allowance: `0.015 C/step`; decision limit: `1.50 C`.

The direct detectors operate on absolute residual magnitudes. The thermal observer instead accumulates positive coolant-trajectory mismatch. A scenario is detected at the first alarm sample at or after its earliest configured campaign event. The baseline has no detection target.
...
- Calibration-memory corruption is not directly represented by the three command-versus-actual residuals. The thermal observer adds a nominal healthy-trajectory check for that indirect fault path.
...
| baseline | thermal_observer | none | 0 | n/a | none | n/a | 0 |
...
| fan_stuck_hot_stress | thermal_observer | fan_stuck_off | 1 | 19.800 | fan_tracking_fault | 0.400 | 0 |
...
| pump_degraded_only | thermal_observer | pump_degraded | 1 | 0.900 | pump_tracking_fault | 1.000 | 0 |
...
| stale_sensor_data_hot_stress | thermal_observer | stale_sensor_data | 1 | 20.800 | coolant_sensor_rationality | 27.000 | 0 |
...
| sensor_bias_only | thermal_observer | sensor_bias | 1 | 0.000 | coolant_sensor_rationality | 0.000 | 0 |
...
| calibration_memory_corruption | thermal_observer | calibration_memory_corruption | 1 | 0.700 | cooling_performance_low | 39.500 | 0 |
...
| paper_default_multi_fault | thermal_observer | sensor_bias+pump_degraded+fan_stuck_off | 1 | 0.000 | coolant_sensor_rationality | 0.000 | 0 |
